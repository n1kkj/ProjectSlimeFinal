    ...
    public class AIHandler : MonoBehaviour
    {
        ...
        void InSight()
        {
            ...
            if (attack != null)
            {
                ...
                states.anim.Play(attack.targerAnim);
                states.anim.SetBool(StaticStrings.canMove, false); // <--------------------------
